...
--                        admin: создаёт отделы, проекты, пользователей; неявно
--                        имеет полные права в любом проекте. editWorkflow /
--                        manageAccess — только у admin. Обычно один, но
--                        допускается несколько (гард держит лишь >= 1 активного).
