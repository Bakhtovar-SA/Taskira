...
| collab-B | Issue collaborators — [`../COLLAB_MIGRATION.md`](../COLLAB_MIGRATION.md) Фазы 1–3, 5–6. Ф1: `008_issue_collaborators.sql` (таблица `issue_collaborators`) ✅. Ф2–6: `manageCollaborators`, fallback в `requireIssuePerm`, одиночный просмотр задачи | 🟡 Ф1 |
