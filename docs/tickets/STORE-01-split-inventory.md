...
**Статус: шаги 1–6 выполнены, фасад снят — разрезание store.tsx завершено (итог: [`STORE-01-report.md`](./STORE-01-report.md))** (`store.tsx` 2 535 → ~500 строк: состояние, индексы,
